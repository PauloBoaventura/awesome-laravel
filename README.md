...
* [Laravel 5 Extended Generators](https://github.com/laracasts/Laravel-5-Generators-Extended) - Estende geradores de arquivos embutidos
* [Laravel API/Scaffold/CRUD Generator](https://github.com/InfyOmLabs/laravel-generator) -Gerador para APIs, andaimes CRUD etc.
* [Laravel Tinx](https://github.com/furey/tinx) - Recarregue sua sessão de Tinker de Laravel de dentro do Tinker
* [Laravel API Documentation Generator](https://github.com/mpociot/laravel-apidoc-generator) - Gerar automaticamente sua documentação da API
* [Laravel Packager](https://github.com/Jeroen-G/Laravel-Packager) - Uma ferramenta da CLI para criar pacotes de laravel
* [Workbench Export to Migrations](https://github.com/beckenrode/mysql-workbench-export-laravel-5-migrations) - Plug -in Workbench para exportar modelos para migrações de Laravel
* [Laravel Decomposer](https://github.com/lubusIN/laravel-decomposer) - Liste todos os pacotes instalados, suas dependências, detalhes de aplicativos e servidores
* [LaRecipe](https://github.com/saleem-hadad/larecipe) -Escreva documentações lindas para seus produtos usando o Markdown dentro do seu aplicativo Laravel.
...
* [Laravel TestTools](https://chrome.google.com/webstore/detail/laravel-testtools/ddieaepnbjhgcbddafciempnibnfnakl) - Extensão do Chrome para gerar testes de integração de Laravel enquanto estiver usando seu aplicativo
* [Laravel Test Factory Generator](https://github.com/mpociot/laravel-test-factory-helper) - Gerar fábricas de teste de Laravel a partir de seus modelos existentes
* [Clockwork](https://github.com/itsgoingd/clockwork) - Integra a Extensão Chrome Clockwork para aplicativos de depuração e criação de criação
* [Debug Bar](https://github.com/barryvdh/laravel-debugbar) -Integra a barra de depuração do PHP com o Laravel
* [Ignition](https://github.com/facade/ignition) -Uma bela página de erro para aplicativos de Laravel
* [Laravel 5 Log Viewer](https://github.com/rap2hpoutre/laravel-log-viewer) - Visualizador de registro
* [LogViewer](https://github.com/ARCANEDEV/LogViewer) - Fornece um visualizador de log
* [LERN](https://github.com/tylercd100/lern#lern-laravel-exception-recorder-and-notifier) - Registre exceções em um banco de dados e enviará uma notificação
* [Mail Preview](https://github.com/themsaid/laravel-mail-preview) - Visualização enviou e -mail em um navegador da web ou cliente de e -mail
* [Laravel Tracy](https://github.com/recca0120/laravel-tracy) -Um pacote de Laravel para integrar o Nette Tracy Debugger
* [Laravel Terminal](https://github.com/recca0120/laravel-terminal) - administrar artesão em um navegador da web
* [Laravel API Tester](https://github.com/asvae/laravel-api-tester) - Ferramenta de correio com rotas de Laravel
* [Laravel Tail](https://github.com/spatie/laravel-tail) - O comando da cauda que falta
* [Laravel Telescope](https://github.com/laravel/telescope) -Laravel Telescope é um elegante assistente de depuração da estrutura do Laravel

##### Authentication & Authorization

* [Bouncer](https://github.com/JosephSilber/bouncer) - Funções e permissões
* [Laratrust](https://github.com/santigarcor/laratrust) - Papéis, permissões e equipes
